        ...
        >
            <div className="container flex sm:justify-between justify-center items-center gap-10 max-sm:flex-col">
                ...
                <ul className="flex gap-5 flex-wrap">
                    ...
                    <a className="flex items-center justify-center w-10 h-10 bg-n-7 rounded-full transition-colors hover:bg-n-6" href='mailto:ebikemeese@gmail.com?subject=Brainwave' target='_blank'>
                        <BiMailSend />
                    </a>
